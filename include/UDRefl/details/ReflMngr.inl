	...
	struct TypeAutoRegister_Default {
		static void run(ReflMngr& mngr) {
			...
			if constexpr (is_valid_v<operator_bool, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_bool, [](const T& obj) -> decltype(auto) { return static_cast<bool>(obj); });

			if constexpr (is_valid_v<operator_add, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_add, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs + rhs; });
			if constexpr (is_valid_v<operator_sub, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_sub, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs - rhs; });
			if constexpr (is_valid_v<operator_mul, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_mul, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs * rhs; });
			if constexpr (is_valid_v<operator_div, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_div, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs / rhs; });
			if constexpr (is_valid_v<operator_mod, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_mod, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs % rhs; });

			if constexpr (is_valid_v<operator_bnot, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_bnot, [](const T& lhs) -> decltype(auto) { return ~lhs; });
			if constexpr (is_valid_v<operator_band, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_band, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs & rhs; });
			if constexpr (is_valid_v<operator_bor, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_bor, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs & rhs; });
			if constexpr (is_valid_v<operator_bxor, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_bxor, [](const T& lhs, const T& rhs) -> decltype(auto) { return lhs & rhs; });
			if constexpr (is_valid_v<operator_lshift, T, std::size_t>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](const T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs << rhs; });
			if constexpr (is_valid_v<operator_rshift, T, std::size_t>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs >> rhs; });
			...
			if constexpr (is_valid_v<operator_lshift, T, std::istringstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](T& lhs, std::istringstream& rhs) -> decltype(auto) { return rhs >> lhs; });
			if constexpr (is_valid_v<operator_lshift, T, std::ifstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](T& lhs, std::ifstream& rhs) -> decltype(auto) { return rhs >> lhs; });
			if constexpr (is_valid_v<operator_lshift, T, std::iostream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](T& lhs, std::iostream& rhs) -> decltype(auto) { return rhs >> lhs; });
			if constexpr (is_valid_v<operator_lshift, T, std::stringstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](T& lhs, std::stringstream& rhs) -> decltype(auto) { return rhs >> lhs; });
			if constexpr (is_valid_v<operator_lshift, T, std::fstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_lshift, [](T& lhs, std::fstream& rhs) -> decltype(auto) { return rhs >> lhs; });
			...
			if constexpr (is_valid_v<operator_rshift, T, std::ostringstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, std::ostringstream& rhs) -> decltype(auto) { return rhs << lhs; });
			if constexpr (is_valid_v<operator_rshift, T, std::ofstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, std::ofstream& rhs) -> decltype(auto) { return rhs << lhs; });
			if constexpr (is_valid_v<operator_rshift, T, std::iostream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, std::iostream& rhs) -> decltype(auto) { return rhs << lhs; });
			if constexpr (is_valid_v<operator_rshift, T, std::stringstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, std::stringstream& rhs) -> decltype(auto) { return rhs << lhs; });
			if constexpr (is_valid_v<operator_rshift, T, std::fstream&>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_rshift, [](const T& lhs, std::fstream& rhs) -> decltype(auto) { return rhs << lhs; });
			...
			if constexpr (is_valid_v<operator_assign_copy, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_assign, [](T& lhs, const T& rhs) -> decltype(auto) { return lhs = rhs; });
			if constexpr (is_valid_v<operator_assign_move, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_assign, [](T& lhs, T&& rhs) -> decltype(auto) { return lhs = std::move(rhs); });
			...
			if constexpr (is_valid_v<operator_assign_lshift, T, std::size_t>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_assign_lshift, [](T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs <<= rhs; });
			if constexpr (is_valid_v<operator_assign_rshift, T, std::size_t>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_assign_rshift, [](T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs >>= rhs; });
			...
			if constexpr (is_valid_v<operator_subscript, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_subscript, [](T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs[rhs]; });
			if constexpr (is_valid_v<operator_subscript_const, T>)
				mngr.AddMemberMethod(StrIDRegistry::Meta::operator_subscript, [](const T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs[rhs]; });
			...
			if constexpr (is_iterator_v<T>) {
				if constexpr (is_valid_v<operator_add, T, std::size_t>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::operator_add, [](const T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs + rhs; });
				if constexpr (is_valid_v<operator_sub, T, std::size_t>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::operator_sub, [](const T& lhs, const std::size_t& rhs) -> decltype(auto) { return lhs - rhs; });
			}
			...
			if constexpr (is_valid_v<tuple_size, T>) {
				...
				mngr.AddMemberMethod(StrIDRegistry::Meta::tuple_get, [](T& t, const std::size_t& i) { return runtime_get<ObjectView>(t, i); });
				mngr.AddMemberMethod(StrIDRegistry::Meta::tuple_get, [](const T& t, const std::size_t& i) { return runtime_get<ObjectView>(t, i); });
			...
			if constexpr (IsContainer_v<T>) {
				...
				if constexpr (is_valid_v<container_cbegin, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_cbegin, [](const T& lhs) -> decltype(auto) { return lhs.cbegin(); });
				...
				if constexpr (is_valid_v<container_cend, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_cend, [](const T& lhs) -> decltype(auto) { return lhs.cend(); });
				...
				if constexpr (is_valid_v<container_at, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_at, [](T& lhs, const std::size_t& n) -> decltype(auto) { return lhs.at(n); });
				if constexpr (is_valid_v<container_at_const, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_at, [](const T& lhs, const std::size_t& n) -> decltype(auto) { return lhs.at(n); });
				...
				if constexpr (is_valid_v<container_resize_0, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_resize, [](T& lhs, const std::size_t& n) -> decltype(auto) { return lhs.resize(n); });

				if constexpr (is_valid_v<container_resize_1, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_resize, [](T& lhs, const std::size_t& n, const typename T::value_type& value) -> decltype(auto) { return lhs.resize(n, value); });
				...
				if constexpr (is_valid_v<container_reserve, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_reserve, [](T& lhs, const std::size_t& n) -> decltype(auto) { return lhs.reserve(n); });
				...
				if constexpr (is_valid_v<container_insert_2, T>)
					mngr.AddMemberMethod(StrIDRegistry::Meta::container_insert, [](T& lhs, typename T::const_iterator iter, const std::size_t& n, const typename T::value_type& value) -> decltype(auto) { return lhs.insert(iter, n, std::move(value)); });
...
namespace Ubpa::UDRefl {
	...
	InvocableResult ReflMngr::IsStaticInvocable(TypeID typeID, StrID methodID) const {
		...
		return IsStaticInvocable(typeID, methodID, std::span<const TypeID>{argTypeIDs});
	}

	template<typename... Args>
	InvocableResult ReflMngr::IsConstInvocable(TypeID typeID, StrID methodID) const {
		constexpr std::array argTypeIDs = { TypeID_of<Args>... };
		return IsConstInvocable(typeID, methodID, std::span<const TypeID>{argTypeIDs});
	}
	...
	template<typename T>
	T ReflMngr::InvokeRet(TypeID typeID, StrID methodID, std::span<const TypeID> argTypeIDs, ArgPtrBuffer argptr_buffer) const {
		if constexpr (!std::is_void_v<T>) {
			using U = std::conditional_t<std::is_reference_v<T>, std::add_pointer_t<T>, T>;
			std::uint8_t result_buffer[sizeof(U)];
			InvokeResult result = Invoke(typeID, methodID, result_buffer, argTypeIDs, argptr_buffer);
	...
	template<typename T>
	T ReflMngr::InvokeRet(ObjectView obj, StrID methodID, std::span<const TypeID> argTypeIDs, ArgPtrBuffer argptr_buffer) const {
		if constexpr (!std::is_void_v<T>) {
			using U = std::conditional_t<std::is_reference_v<T>, std::add_pointer_t<T>, T>;
			std::uint8_t result_buffer[sizeof(U)];
	...
	InvokeResult ReflMngr::InvokeArgs(TypeID typeID, StrID methodID, void* result_buffer, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			...
			return Invoke(typeID, methodID, result_buffer, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
	...
	template<typename... Args>
	InvokeResult ReflMngr::InvokeArgs(ObjectView obj, StrID methodID, void* result_buffer, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
	...
	T ReflMngr::Invoke(TypeID typeID, StrID methodID, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return InvokeRet<T>(typeID, methodID, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
	...
	bool ReflMngr::Construct(ObjectView obj, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return Construct(obj, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
			return Construct(obj, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr));
	}
	...
	ObjectView ReflMngr::New(TypeID typeID, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return New(typeID, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
			return New(typeID, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr));
	}
	...
	SharedObject ReflMngr::MakeShared(TypeID typeID, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return MakeShared(typeID, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
			return MakeShared(typeID, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr));
	}
		...
		Args&&... args) const
	{
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return MInvoke(typeID, methodID, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()), rst_rsrc);
		}
		else
			return MInvoke(typeID, methodID, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr), rst_rsrc);
	}
		...
		Args&&... args) const
	{
		if constexpr (sizeof...(Args) > 0) {
			...
			return MInvoke(obj, methodID, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr), rst_rsrc);
	}
	...
	template<typename... Args>
	ObjectView ReflMngr::MNew(TypeID typeID, std::pmr::memory_resource* rsrc, Args&&... args) const {
		if constexpr (sizeof...(Args) > 0) {
			constexpr std::array argTypeIDs = { TypeID_of<decltype(args)>... };
			const std::array argptr_buffer{ const_cast<void*>(reinterpret_cast<const void*>(&args))... };
			return MNew(typeID, rsrc, std::span<const TypeID>{ argTypeIDs }, static_cast<ArgPtrBuffer>(argptr_buffer.data()));
		}
		else
			return MNew(typeID, rsrc, std::span<const TypeID>{}, static_cast<ArgPtrBuffer>(nullptr));
	}
}
